...
/// <summary>
/// OpenSearch implementation of <see cref="ISquashProvider"/>. Discovered
/// by the CLI via the migration assembly's reference closure (per ADR-0024).
/// </summary>
public sealed class OpenSearchSquashProvider : ISquashProvider
{
    ...
    public OpenSearchSquashProvider( IEphemeralProvisioner provisioner )
    {
