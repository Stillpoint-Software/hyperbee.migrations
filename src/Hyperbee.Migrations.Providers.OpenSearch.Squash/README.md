# Hyperbee.Migrations.Providers.OpenSearch.Squash

OpenSearch `ISquashProvider` implementation for the `hyperbee-migrations`
...
```bash
dotnet add package Hyperbee.Migrations.Providers.OpenSearch.Squash
```
