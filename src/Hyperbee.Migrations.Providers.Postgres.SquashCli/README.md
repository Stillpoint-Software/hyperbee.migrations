# Hyperbee.Migrations.Providers.Postgres.SquashCli

Postgres `ISquashCliProvider` implementation for the `hyperbee-migrations`
...
```bash
dotnet add package Hyperbee.Migrations.Providers.Postgres.SquashCli
```
