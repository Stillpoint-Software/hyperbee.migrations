...
/// <summary>
/// Postgres implementation of <see cref="ISquashProvider"/>. Discovered by
/// the CLI via the migration assembly's reference closure (per ADR-0024);
/// requires only a public parameterless constructor.
/// </summary>
public sealed class PostgresSquashProvider : ISquashProvider
{
    ...
    /// <summary>
    /// Default ctor used by <see cref="SquashProviderRegistry.Discover"/>
    /// (requires public parameterless ctor). Wires the default
    /// <see cref="PostgresEphemeralProvisioner"/>.
    /// </summary>
    public PostgresSquashProvider()
    ...
    /// </summary>
    public PostgresSquashProvider( IEphemeralProvisioner provisioner )
    {
