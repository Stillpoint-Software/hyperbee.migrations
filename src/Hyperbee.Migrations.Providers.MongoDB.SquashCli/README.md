# Hyperbee.Migrations.Providers.MongoDB.SquashCli

MongoDB `ISquashCliProvider` implementation for the `hyperbee-migrations`
...
```bash
dotnet add package Hyperbee.Migrations.Providers.MongoDB.SquashCli
```
