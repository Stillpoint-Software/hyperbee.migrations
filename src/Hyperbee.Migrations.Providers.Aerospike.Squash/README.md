# Hyperbee.Migrations.Providers.Aerospike.Squash

Aerospike `ISquashProvider` implementation for the `hyperbee-migrations`
...
```bash
dotnet add package Hyperbee.Migrations.Providers.Aerospike.Squash
```
