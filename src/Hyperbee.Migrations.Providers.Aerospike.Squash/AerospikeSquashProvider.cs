...
/// <summary>
/// Aerospike implementation of <see cref="ISquashProvider"/>. Discovered
/// by the CLI via the migration assembly's reference closure (per ADR-0024).
/// </summary>
public sealed class AerospikeSquashProvider : ISquashProvider
{
    ...
    public AerospikeSquashProvider( IEphemeralProvisioner provisioner )
    {
