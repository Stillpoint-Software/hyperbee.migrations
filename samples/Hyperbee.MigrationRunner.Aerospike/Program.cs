...
internal class Program
{
    public static async Task Main( string[] args )
    {
        ...
        try
        {
            ...
            await Host
                ...
                {
                    services
                        .AddAerospikeProvider( context.Configuration, logger )
                        .AddAerospikeMigrations( context.Configuration )
    ...
    private static Dictionary<string, string> SwitchMappings()
    {
        return new Dictionary<string, string>()
        {
            ...
            { "-n", "Migrations:Namespace" },
            { "-s", "Migrations:MigrationSet" },

            { "-cs", "Aerospike:ConnectionString" },
            ...
            { "--set", "Migrations:MigrationSet" },

            { "--connection", "Aerospike:ConnectionString" }
        };
    }
}
